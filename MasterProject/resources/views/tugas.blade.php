...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="#">Arief Darmawan 8020230033</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            <button class="nav-link text-secondary" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                Tentang UNAMA
                            </button>
        ...
        <div class="card my-3">
            ...
            <div class="card-footer">
                <div class="row align-items-start">
                    ...
                    <div class="col col-md-4 ms-xl-3">
